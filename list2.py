...
def linear_merge(list1, list2):
    ...
    index2 = 0
    word_list = []
    while index1 < len(list1) and index2:
        if list1[index1] < list2[index2]:
            word_list.append(list1[index1])
            index1 += 1
        else:
            word_list.append(list2[index2])
            index2 += 1
    return word_list + list1[index1:] + list2[index2:]
